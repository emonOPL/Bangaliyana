...
namespace Bangaliyana.Areas.Moderator.Controllers
{
    ...
    public class ContactInquiriesController : Controller
    {
        ...
        public async Task<IActionResult> Index(InquiryStatus? status)
        {
            ...
            ViewBag.ControllerName = "ContactInquiries";

            return View("~/Areas/Admin/Views/ContactInquiries/Index.cshtml", inquiries);
        }
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            return View("~/Areas/Admin/Views/ContactInquiries/Details.cshtml", inquiry);
        }
        ...
        public async Task<IActionResult> Respond(int id, string response, bool sendEmail)
        {
            ...
            if (sendEmail)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    TempData["Warning"] = _localizer["ResponseSavedEmailFailed"].Value;
                }
            }
            else
            {
